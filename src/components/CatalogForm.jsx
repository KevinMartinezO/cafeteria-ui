            ...
            <div className="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="id_catalog_type" className="block text-sm font-medium text-[#6f4e37] mb-1">
                                Tipo de Catálogo *
                            </label>
                            <select
                                id="id_catalog_type"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="cost" className="block text-sm font-medium text-[#6f4e37] mb-1">
                                    Costo (HNL) *
                                </label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label htmlFor="discount" className="block text-sm font-medium text-[#6f4e37] mb-1">
                                    Descuento (%)
                                </label>
                                <input
                                    type="number"
